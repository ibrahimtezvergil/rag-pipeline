...
- [ ] Audio loader — Gemini Embedding 2 native embed (120s clip window'lara böl) — Ref: `rag-service/app/services/media.py`, `rag-service/app/services/ingestion.py` | Akış: `audio -> 120s clips -> embed -> chunk rows` ⚠️ Implement edilmedi: `media.py` sadece generic binary loader; audio source_type case'i ve 120s clip bölme yok
